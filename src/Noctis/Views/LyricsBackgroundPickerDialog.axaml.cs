...
/// <summary>Settings › Appearance › Lyrics Background Video › Modify. Same overlay card and
/// fade/scale open-close as <see cref="AddSongsDialog"/>.</summary>
public partial class LyricsBackgroundPickerDialog : Window
{
    ...
    public LyricsBackgroundPickerDialog()
    {
        ...
        {
            if (DataContext is LyricsBackgroundPickerViewModel vm)
            {
